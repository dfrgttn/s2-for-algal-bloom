...
if __name__ == '__main__':
    ...
    model_map = {
        "baseline_dnn" : model_1_baseline(INPUTS_COLS, [ARG_FC_SIZE * 4, ARG_FC_SIZE]),
        "residual_dnn" : model_2_residual(INPUTS_COLS, ARG_FC_SIZE),
        "residual_mha_dnn" : model_3_mha_residual(INPUTS_COLS, ARG_FC_SIZE),
        "residual_mha_dnn_v2" : model_3_mha_residual_v2(INPUTS_COLS, ARG_FC_SIZE),
        "grn_vsn_dnn" : model_4_grn_vsn(INPUTS_COLS, ARG_FC_SIZE),
        "grn_vsn_dnn_v2" : model_4_grn_vsn(INPUTS_COLS, ARG_FC_SIZE, fc_layer = True),
        "grn_vsn_dnn_v3" : model_4_grn_vsn(INPUTS_COLS, ARG_FC_SIZE),
        "grn_vsn_dnn_v4" : model_4_grn_vsn(INPUTS_COLS,  ARG_FC_SIZE, fc_layer = True),
        "grn_vsn_dnn_mha" : model_4_grn_vsn(INPUTS_COLS, ARG_FC_SIZE, mha_layer = True),
        "mha_dnn" : model_5_mha(INPUTS_COLS, ARG_FC_SIZE),
        "wide_deep_dnn" : model_6_wide_deep(INPUTS_COLS, [ARG_FC_SIZE * 4, ARG_FC_SIZE]),
        "wide_deep_dnn_mha" : model_6_wide_deep(INPUTS_COLS, [ARG_FC_SIZE * 4, ARG_FC_SIZE], mha_layer = True),
        "cross_deep_dnn" : model_7_deep_cross(INPUTS_COLS, [ARG_FC_SIZE * 4, ARG_FC_SIZE]),
        "cross_deep_mha_dnn" : model_7_deep_cross(INPUTS_COLS, [ARG_FC_SIZE * 4, ARG_FC_SIZE], mha_layer = True),
    }
