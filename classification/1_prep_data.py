...
if __name__ == '__main__':
    ...
    df_test[COLS_TO_USE].to_csv("test_data.csv", index=False)
    df_train[COLS_TO_USE].to_csv("train_data.csv", index=False)
    
    df_test.to_csv("test_data_orig.csv", index=False)
    df_train.to_csv("train_data_orig.csv", index=False)
