...
if __name__ == '__main__':
    ...
    ap.add_argument("-train", "--train_data", required=False,
            default = "./train_data.csv", help="path to train data")
    ap.add_argument("-test", "--test_data", required=False,
            default = "./test_data.csv", help="path to test data")
    ...
    model_map = {
        ...
        "grn_vsn_dnn" : model_4_grn_vsn(INPUTS_COLS, 4),
        "grn_vsn_dnn_v2" : model_4_grn_vsn(INPUTS_COLS, 16, fc_layer = True),
        "grn_vsn_dnn_v3" : model_4_grn_vsn(INPUTS_COLS, 64),
        "grn_vsn_dnn_v4" : model_4_grn_vsn(INPUTS_COLS,  64, fc_layer = True),
        "grn_vsn_dnn_mha" : model_4_grn_vsn(INPUTS_COLS, 128, mha_layer = True),
    ...
    _, accuracy, _, _, _, _, _, _ = model.evaluate(test_dataset)
